    ...
    $("#vTitle").html(localStorage.getItem('chnnelTitle'))

    //localStorage.removeItem("streamTitle");
    //localStorage.removeItem("serverURL");
    localStorage.removeItem("chnnelTitle");
    ...
    function init_page() {
        ...
        try {
            Flashphoner.init({
                flashMediaProviderSwfLocation: 'assets/media-provider.swf',
                receiverLocation: 'assets/flashphoner/dependencies/websocket-player/WSReceiver2.js',
                decoderLocation: 'assets/flashphoner/dependencies/websocket-player/video-worker2.js',
        ...
        if (Flashphoner.getMediaProviders()[0] == "WSPlayer") {
            resolution_for_wsplayer = { playWidth: "100%", playHeight: "100%" };
        }
